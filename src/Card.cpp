...
void Card::SetValue() {
    if (_value == 11) {
        _value = 1;  // Change Ace value from 11 to 1
        convertValueToString(_value); // Update the string representation for the card
    }

    // Recalculate the string representation based on the new value
